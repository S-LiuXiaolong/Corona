...
class ImguiDemo final : public EngineBase
{
public:
    ~ImguiDemo();

    virtual void Initialize(const EngineInitInfo& InitInfo) override final;

    virtual void Render() override final;
    virtual void Update(double CurrTime, double ElapsedTime) override final;

    virtual const Char* GetEngineName() const override final { return "Dear Imgui Demo"; }
